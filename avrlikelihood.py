...
def lnlh(data, params, hyperparams):
    ...
    variances_W = variance_W0 * (ages/hyperparams.get_age0())**beta_W *\
...
def lnprior(params, hyperparams):
    ...
    """
    variance_W0, beta_W, scalelen_W = params #you're pathetic
    if variance_W0 < 0.:
        return -np.Inf
...
if __name__ == "__main__":
    ...
    hyperparams = HyperParams(data.spacevel_err[:,2,2])
    pass
