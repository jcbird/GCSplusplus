...
apogee_data_dir = '/Users/jquark/obs_data/apogee'
...
ness_cat = np.loadtxt(ness_age_cat_file, dtype=ndtypes)
...
#if not (RCcat['APOGEE_ID']==ness_cat['APOGEE_ID']).all():
    #print('ABORT, catalogs not matched!')
   # sys.exit()
